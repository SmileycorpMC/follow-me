...
public class PlayerDataCondition<T extends Comparable<T>> extends DataCondition {

	protected final NBTExplorer<T> explorer;
	protected final T value;
	protected final EnumOperation operation;

	public PlayerDataCondition(NBTExplorer<T> explorer, T value, EnumOperation operation) {
